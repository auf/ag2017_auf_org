...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hotel.cacher_dans_tableau_de_bord'
        db.add_column('gestion_hotel', 'cacher_dans_tableau_de_bord',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Hotel.cacher_dans_tableau_de_bord'
        db.delete_column('gestion_hotel', 'cacher_dans_tableau_de_bord')
    ...
    models = {
        ...
        'gestion.activitescientifique': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'libelle': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'max_participants': ('django.db.models.fields.IntegerField', [], {'default': '999'})
        },
        'gestion.agrole': {
        ...
        'gestion.hotel': {
            ...
            'cacher_dans_tableau_de_bord': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'code': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'njA9f54vE5CShK9pFDabsClvu8k6p9rB'", 'max_length': '32'}),
