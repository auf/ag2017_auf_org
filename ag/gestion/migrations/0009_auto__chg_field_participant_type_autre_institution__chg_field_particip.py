...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participant.type_autre_institution'
        db.alter_column('gestion_participant', 'type_autre_institution_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gestion.TypeInstitutionSupplementaire'], null=True, on_delete=models.PROTECT))

        # Changing field 'Participant.vol_groupe'
        db.alter_column('gestion_participant', 'vol_groupe_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gestion.VolGroupe'], null=True, on_delete=models.PROTECT))

        # Changing field 'Participant.statut'
        db.alter_column('gestion_participant', 'statut_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gestion.StatutParticipant'], on_delete=models.PROTECT))

        # Changing field 'Participant.hotel'
        db.alter_column('gestion_participant', 'hotel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gestion.Hotel'], null=True, on_delete=models.PROTECT))
        # Adding field 'Frais.quantite'
        db.add_column('gestion_frais', 'quantite',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Participant.type_autre_institution'
        db.alter_column('gestion_participant', 'type_autre_institution_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gestion.TypeInstitutionSupplementaire'], null=True))

        # Changing field 'Participant.vol_groupe'
        db.alter_column('gestion_participant', 'vol_groupe_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gestion.VolGroupe'], null=True))

        # Changing field 'Participant.statut'
        db.alter_column('gestion_participant', 'statut_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gestion.StatutParticipant']))

        # Changing field 'Participant.hotel'
        db.alter_column('gestion_participant', 'hotel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gestion.Hotel'], null=True))
        # Deleting field 'Frais.quantite'
        db.delete_column('gestion_frais', 'quantite')
    ...
    models = {
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'I8thS9V6PIyoOLPjzAdGUqtHOQJ9w8lM'", 'max_length': '32'}),
