...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.activite_scientifique'
        db.add_column('gestion_participant', 'activite_scientifique',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Participant.activite_scientifique'
        db.delete_column('gestion_participant', 'activite_scientifique_id')
    ...
    models = {
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'rC1AfFZjshEnneQJH9H34AGPUS7DJTxe'", 'max_length': '32'}),
