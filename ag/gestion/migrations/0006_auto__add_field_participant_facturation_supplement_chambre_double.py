...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.facturation_supplement_chambre_double'
        db.add_column('gestion_participant', 'facturation_supplement_chambre_double',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Participant.facturation_supplement_chambre_double'
        db.delete_column('gestion_participant', 'facturation_supplement_chambre_double')
    ...
    models = {
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'Lr9GN4n32nhnKDsI9jDLDxHrq3RqN9uD'", 'max_length': '32'}),
