...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiviteScientifique.max_participants'
        db.add_column('gestion_activitescientifique', 'max_participants',
                      self.gf('django.db.models.fields.IntegerField')(default=999),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ActiviteScientifique.max_participants'
        db.delete_column('gestion_activitescientifique', 'max_participants')
    ...
    models = {
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'gH56o5kylO5p5IWvEXdIB5C6tOwOOefl'", 'max_length': '32'}),
