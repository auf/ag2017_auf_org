...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.montant_accompte_devise_locale'
        db.add_column('gestion_participant', 'montant_accompte_devise_locale',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participant.accompte_devise_locale'
        db.add_column('gestion_participant', 'accompte_devise_locale',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Participant.montant_accompte_devise_locale'
        db.delete_column('gestion_participant', 'montant_accompte_devise_locale')

        # Deleting field 'Participant.accompte_devise_locale'
        db.delete_column('gestion_participant', 'accompte_devise_locale')
    ...
    models = {
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'A0MaQvtGMCebmVqevOp9O0VhOpFrKgYH'", 'max_length': '32'}),
