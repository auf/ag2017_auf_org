...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.commentaires'
        db.add_column('gestion_participant', 'commentaires',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Participant.commentaires'
        db.delete_column('gestion_participant', 'commentaires')
    ...
    models = {
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'0VI8etKoKRJDgkawN88Mw3zwK2VAuqyf'", 'max_length': '32'}),
