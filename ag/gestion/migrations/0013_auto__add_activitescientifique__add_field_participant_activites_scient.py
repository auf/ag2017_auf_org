...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActiviteScientifique'
        db.create_table('gestion_activitescientifique', (
        ...
        db.send_create_signal('gestion', ['ActiviteScientifique'])

        # Adding field 'Participant.activites_scientifiques'
        db.add_column('gestion_participant', 'activites_scientifiques',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gestion.ActiviteScientifique'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'ActiviteScientifique'
        db.delete_table('gestion_activitescientifique')

        # Deleting field 'Participant.activites_scientifiques'
        db.delete_column('gestion_participant', 'activites_scientifiques_id')
    ...
    models = {
        ...
        'gestion.activitescientifique': {
            'Meta': {'object_name': 'ActiviteScientifique'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'libelle': ('django.db.models.fields.CharField', [], {'max_length': '256'})
        },
        ...
        'gestion.participant': {
            ...
            'activites_scientifiques': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gestion.ActiviteScientifique']", 'null': 'True', 'blank': 'True'}),
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'2xcwQvgbneJ3MGLruvIpvZU1PzBiGNbr'", 'max_length': '32'}),
