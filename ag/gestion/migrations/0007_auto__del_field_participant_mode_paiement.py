...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Participant.mode_paiement'
        db.delete_column('gestion_participant', 'mode_paiement')

    def backwards(self, orm):
        # Adding field 'Participant.mode_paiement'
        db.add_column('gestion_participant', 'mode_paiement',
    ...
    models = {
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'QOEyWHCsOkbrjyxmPivjIB8bnOCHRcYA'", 'max_length': '32'}),
