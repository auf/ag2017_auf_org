...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AGRole'
        db.create_table('gestion_agrole', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='roles', to=orm['auth.User'])),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Region'], null=True)),
            ('type_role', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('gestion', ['AGRole'])

    def backwards(self, orm):
        # Deleting model 'AGRole'
        db.delete_table('gestion_agrole')
    ...
    models = {
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'o6pQu6YFbjDae2R6Io3syjemDyrDxd9R'", 'max_length': '32'}),
