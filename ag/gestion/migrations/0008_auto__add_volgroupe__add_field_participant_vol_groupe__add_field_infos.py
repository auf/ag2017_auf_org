...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VolGroupe'
        db.create_table('gestion_volgroupe', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nom', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('nombre_de_sieges', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('gestion', ['VolGroupe'])

        # Adding field 'Participant.vol_groupe'
        db.add_column('gestion_participant', 'vol_groupe',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gestion.VolGroupe'], null=True),
                      keep_default=False)

        # Adding field 'InfosVol.vol_groupe'
        db.add_column('gestion_infosvol', 'vol_groupe',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gestion.VolGroupe'], null=True),
                      keep_default=False)


        # Changing field 'InfosVol.participant'
        db.alter_column('gestion_infosvol', 'participant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gestion.Participant'], null=True))
    def backwards(self, orm):
        # Deleting model 'VolGroupe'
        db.delete_table('gestion_volgroupe')

        # Deleting field 'Participant.vol_groupe'
        db.delete_column('gestion_participant', 'vol_groupe_id')

        # Deleting field 'InfosVol.vol_groupe'
        db.delete_column('gestion_infosvol', 'vol_groupe_id')


        # User chose to not deal with backwards NULL issues for 'InfosVol.participant'
        raise RuntimeError("Cannot reverse this migration. 'InfosVol.participant' and its values cannot be restored.")
    models = {
        'auth.group': {
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'qBfHjYx4fzxMpxhqONaSPKhdDogt7U55'", 'max_length': '32'}),
