...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.region'
        db.add_column('gestion_participant', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Region'], null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Participant.region'
        db.delete_column('gestion_participant', 'region_id')
    ...
    models = {
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'6XdJNgcGyTzzfuMSGetG4bWRqH64gtK2'", 'max_length': '32'}),
