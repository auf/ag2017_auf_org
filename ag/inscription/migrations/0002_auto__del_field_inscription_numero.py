...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Inscription.numero'
        db.delete_column('inscription_inscription', 'numero')

    def backwards(self, orm):
        # Adding field 'Inscription.numero'
        db.add_column('inscription_inscription', 'numero',
    ...
    models = {
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'MmIu4MSvuWJTHXwQrohWEC1WhHMjM5Q8'", 'max_length': '32'}),
