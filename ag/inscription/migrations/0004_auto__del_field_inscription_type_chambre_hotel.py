...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Inscription.type_chambre_hotel'
        db.delete_column('inscription_inscription', 'type_chambre_hotel')

    def backwards(self, orm):
        # Adding field 'Inscription.type_chambre_hotel'
        db.add_column('inscription_inscription', 'type_chambre_hotel',
    ...
    models = {
        ...
        'inscription.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jeton': ('django.db.models.fields.CharField', [], {'default': "'r3l4V8WpLbRcwyZ1n1iW7rpzph88pF6R'", 'max_length': '32'}),
